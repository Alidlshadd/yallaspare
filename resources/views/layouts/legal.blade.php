        ...
        <header class="h-16 border-b border-slate-200/60 bg-white dark:border-slate-800/60 dark:bg-slate-950">
            <div class="mx-auto flex h-full w-full max-w-6xl items-center justify-between px-6">
                <a
                    ...
                    class="text-sm font-semibold tracking-tight text-slate-900 transition-opacity duration-200 hover:opacity-70 focus:outline-none focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-2 focus-visible:ring-offset-white dark:text-slate-100 dark:focus-visible:ring-accent dark:focus-visible:ring-offset-slate-950"
                >
                    {{ __('Yalla Spare') }}
                </a>
