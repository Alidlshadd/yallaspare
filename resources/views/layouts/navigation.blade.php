...
@endphp
<nav x-data="mobileNav" class="border-b border-slate-200/70 bg-white/95 backdrop-blur">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="flex h-16 items-center justify-between gap-4">
            <div class="flex min-w-0 items-center gap-4 sm:gap-8">
                <div class="flex shrink-0 items-center">
                    <div class="header-logo-area">
                    <a href="{{ route($dashboardRoute) }}" class="app-logo app-logo-light app-logo-user focus:outline-none focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-2">
                        <x-brand-mark
            ...
            <div class="flex items-center sm:hidden">
                <button @click="toggle" aria-label="{{ __('Menu') }}" :aria-expanded="open ? 'true' : 'false'" class="inline-flex items-center justify-center rounded-xl border border-slate-200 bg-white p-2 text-slate-500 transition duration-200 hover:bg-slate-50 hover:text-slate-700 focus:outline-none focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-2">
    ...
    <div :class="drawerClasses" class="hidden sm:hidden">
