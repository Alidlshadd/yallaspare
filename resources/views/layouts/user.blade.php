                ...
                <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    ...
                    <div class="hidden py-2.5 lg:grid lg:grid-cols-[minmax(11rem,0.75fr)_minmax(30rem,1.45fr)_minmax(11rem,0.75fr)] lg:items-center lg:gap-4">
                        ...
                        <form method="GET" action="{{ route('shop.index') }}" class="w-full min-w-0 justify-self-center" data-search-autocomplete data-search-autocomplete-url="{{ route('shop.autocomplete') }}">
                            <div class="relative mx-auto w-full max-w-[40rem]">
                                ...
                                <input
                                    ...
                                    autocomplete="off"
                                    data-search-autocomplete-input
                                    class="block h-10 w-full rounded-full border border-white/10 bg-white/10 py-2 pl-12 pr-24 text-sm text-white outline-none transition duration-200 placeholder:text-white/45 focus:border-white/20 focus:bg-white/15 focus:ring-4 focus:ring-white/10"
                                />
                                <button
                                    type="submit"
                                    class="absolute {{ $isRtl ? 'left-1' : 'right-1' }} top-1 inline-flex h-8 items-center justify-center rounded-full bg-white px-3.5 text-sm font-semibold text-primary transition duration-200 hover:bg-white/90 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/40"
                                >
                                    {{ __('Search') }}
                                </button>
                                <div data-search-autocomplete-panel class="absolute left-0 right-0 top-full z-50 mt-2 hidden overflow-hidden rounded-2xl border border-slate-200 bg-white text-slate-900 shadow-xl shadow-slate-950/20 dark:border-slate-700 dark:bg-slate-950 dark:text-white"></div>
