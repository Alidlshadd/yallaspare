            ...
            <section class="rounded-3xl border border-slate-200/80 bg-white p-6 shadow-sm shadow-slate-900/5 dark:border-slate-800 dark:bg-slate-900 dark:shadow-black/10 sm:p-8">
                ...
                <form action="{{ route('user.settings.accessibility.update') }}" method="POST" class="mt-6 space-y-6">
                    ...
                    <label class="flex items-start gap-3 rounded-2xl border border-slate-200/80 bg-slate-50 px-4 py-4 transition duration-200 hover:border-[#070740]/20 hover:bg-white dark:border-slate-800 dark:bg-slate-950 dark:hover:border-[#070740]/30 dark:hover:bg-slate-900">
                        <input type="checkbox" name="reduced_motion" value="1" @checked(old('reduced_motion', $user->reduced_motion ?? false)) class="mt-0.5 h-4 w-4 rounded border-slate-300 text-[#070740] focus:ring-[#070740]/30">
                        <span class="min-w-0">
                    ...
                    <label class="flex items-start gap-3 rounded-2xl border border-slate-200/80 bg-slate-50 px-4 py-4 transition duration-200 hover:border-[#070740]/20 hover:bg-white dark:border-slate-800 dark:bg-slate-950 dark:hover:border-[#070740]/30 dark:hover:bg-slate-900">
                        <input type="checkbox" name="high_contrast_mode" value="1" @checked(old('high_contrast_mode', $user->high_contrast_mode ?? false)) class="mt-0.5 h-4 w-4 rounded border-slate-300 text-[#070740] focus:ring-[#070740]/30">
                        <span class="min-w-0">
