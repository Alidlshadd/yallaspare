    ...
    <div class="space-y-6 sm:space-y-8 lg:space-y-10">
        <section class="relative mx-auto w-full overflow-hidden rounded-2xl border border-navy/10 bg-navy-deep shadow-sm shadow-navy/10 dark:border-white/10 dark:shadow-black/20 sm:rounded-3xl">
            <div class="absolute inset-0 overflow-hidden">
                @if ($heroVideoUrl)
                    ...
                    @else
                        <div
                            class="absolute inset-0 h-full w-full bg-[linear-gradient(135deg,#070740_0%,#070740_52%,#04041f_100%)]"
                            data-hero-video-fallback
                        ></div>
                    @endif
                    <video
        ...
        <section class="space-y-5">
            <div class="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between sm:gap-3">
                <div class="min-w-0">
                    <h2 class="text-xl font-semibold text-slate-950">{{ __('Browse Categories') }}</h2>
                    <p class="mt-1 text-sm text-slate-500">{{ __('Start from the system you need and narrow down quickly.') }}</p>
                </div>
                <a
            ...
            <div class="grid grid-cols-2 gap-3 sm:gap-4 md:grid-cols-3 lg:grid-cols-5">
                ...
                @empty
                    <div class="rounded-3xl border border-dashed border-slate-300 bg-white p-8 text-center text-sm font-medium text-slate-500 dark:border-slate-700 dark:bg-slate-900 sm:col-span-2 lg:col-span-5">
