...
@php
    ...
    $inputClass = 'block w-full rounded-lg border border-slate-200 bg-white px-3 py-2.5 text-sm text-slate-900 placeholder-muted transition duration-200 focus:border-red-500 focus:ring-accent dark:border-slate-700 dark:bg-slate-800/90 dark:text-slate-100';
