<x-app-layout>
    <x-slot name="header">{{ __('Edit Popup') }}</x-slot>
        ...
        <div class="relative overflow-hidden rounded-2xl mb-4 p-6 text-white"
            ...
            <div class="relative flex flex-wrap items-center justify-between gap-4">
                <div>
                    ...
                    <h1 class="text-2xl font-black mt-2 leading-tight">{{ __('Edit Popup') }}</h1>
                    <p class="text-sm text-white/65 mt-1.5">{{ $popup->title_en }}</p>
                </div>
