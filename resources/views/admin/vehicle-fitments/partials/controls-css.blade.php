...
.dark .vf-btn { background: var(--surface-sunk); border-color: var(--border); color: var(--text-secondary); }
.dark .vf-btn:hover { background: linear-gradient(var(--hover-tint), var(--hover-tint)), var(--surface-sunk); }
...
.dark .vf-inp, .dark .vf-sel { background: var(--surface-sunk); border-color: var(--border); color: var(--text); }
.dark .vf-inp:focus, .dark .vf-sel:focus { background: var(--surface); }
...
.vf-tagbox {
    ...
    border: 1px solid var(--border); border-radius: 10px; background: var(--surface-sunk); cursor: text;
}
.vf-tagbox:focus-within { border-color: #ff8a3d; background: var(--surface); box-shadow: 0 0 0 3px rgb(255 138 61 / .25); }
.vf-tagbox input[data-engine-tag-input] {
    flex: 1 1 130px; min-width: 110px; height: 26px; padding: 0 3px; border: 0; outline: none;
    background: transparent; color: var(--text); font-size: 12px; box-shadow: none;
}
.vf-tag {
...
.dark .vf-tagbox { background: var(--surface-sunk); border-color: var(--border); }
.dark .vf-tagbox:focus-within { background: var(--surface); }
.dark .vf-tagbox input[data-engine-tag-input] { color: var(--text); }
