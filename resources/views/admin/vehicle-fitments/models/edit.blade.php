<x-app-layout>
    ...
    <div class="mx-auto max-w-6xl space-y-5 px-3 py-5 sm:px-5">
        ...
        @if($fitmentCount > 0)
            <div class="rounded-xl border border-amber-300 bg-amber-50 px-4 py-3 text-[12.5px] text-amber-900 dark:border-amber-500/30 dark:bg-amber-500/5 dark:text-amber-200">
