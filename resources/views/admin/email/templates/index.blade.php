<x-app-layout>
        ...
        <div class="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <h2 class="text-2xl font-semibold text-slate-900 mt-1">{{ __('Template Editor') }}</h2>
                </div>
            </div>
        </div>
    </x-slot>
    ...
    <div class="mx-auto max-w-[1600px] px-4 sm:px-6 lg:px-8 space-y-6">
        ...
        {{-- Header card --}}
        <div class="relative rounded-2xl border border-slate-200/70 bg-white overflow-hidden shadow-sm">
            ...
            <div class="flex flex-wrap items-center justify-between gap-3 px-5 py-4">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-2xl font-semibold text-slate-900 leading-tight mt-1 tracking-tight">{{ count($rows) }} {{ __('templates') }} · {{ count($rows) * count(\App\Models\EmailTemplate::LOCALES) }} {{ __('locales') }}</p>
  ...
  'border-slate-200 bg-slate-50 text-slate-700'))))))) }}">
                            ...
                            <div class="flex-1 min-w-0">
                                ...
                                <p class="text-xs text-slate-500 mt-0.5">{{ $row['description'] }}</p>
