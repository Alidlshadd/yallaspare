                ...
                <div class="flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
                    <div class="flex min-w-0 items-center gap-4">
                        <div class="relative shrink-0">
                            ...
                            @else
                                <div class="flex h-20 w-20 items-center justify-center rounded-xl border border-white/15 bg-navy-deep text-2xl font-bold text-accent">
                                    {{ $avatarInitial }}
                                </div>
                            @endif
                        ...
                        <div class="min-w-0">
                            <p class="text-[11px] font-bold uppercase tracking-[0.18em] text-white/50">{{ __('Admin Profile') }}</p>
                            <h1 class="mt-1 truncate text-2xl font-bold tracking-tight sm:text-3xl">{{ $user->name }}</h1>
