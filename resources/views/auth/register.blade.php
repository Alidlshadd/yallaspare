    ...
    <form method="POST" action="{{ route('register') }}" class="mt-5 space-y-4" data-auth-form data-loading-button-text="Processing...">
        ...
        <div>
            ...
            <div class="mt-2 grid grid-cols-[7.5rem_minmax(0,1fr)] gap-2" dir="ltr">
                ...
                <input
                    id="phone"
                    class="block w-full rounded-lg border border-slate-200 bg-white px-3 py-2.5 text-sm text-slate-900 placeholder:text-slate-400 transition duration-200 focus:border-accent focus:ring-accent dark:border-slate-700 dark:bg-slate-800/90 dark:text-slate-100 dark:placeholder:text-slate-500"
                    type="tel"
                    inputmode="tel"
                    name="phone"
                    value="{{ old('phone') }}"
