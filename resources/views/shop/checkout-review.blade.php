            ...
            <aside class="space-y-4">
                <section class="rounded-3xl border border-slate-200/80 bg-white p-5 shadow-sm shadow-slate-900/5 dark:bg-slate-900 dark:shadow-black/10">
                    ...
                    >
                        ...
                        <input type="hidden" name="address_id" value="{{ $address->id }}">
                        <input type="hidden" name="notes" value="{{ $notes }}">
                        <div class="rounded-2xl border border-slate-200/80 bg-white p-3 dark:bg-slate-950">
                            ...
                            <div class="mt-3 space-y-2">
                                @foreach($paymentMethods as $method)
                                    ...
                                    <label class="flex items-center gap-3 rounded-xl border border-slate-200 bg-slate-50 px-3 py-2 text-sm transition {{ $isDisabled ? 'cursor-not-allowed opacity-60' : 'cursor-pointer hover:border-primary/30' }}">
                                        <input
                                            type="radio"
                                            name="payment_method"
                                            value="{{ $method['key'] }}"
                                        ...
                                        >
                                        <span class="flex-1 font-medium text-slate-900">{{ __($method['label']) }}</span>
