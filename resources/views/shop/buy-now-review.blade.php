        ...
        <form action="{{ route('checkout.buy-now', $product) }}" method="POST" class="space-y-6">
            ...
            <section class="rounded-3xl border border-slate-200/80 bg-white p-5 shadow-sm shadow-slate-900/5 dark:border-slate-800 dark:bg-slate-900 dark:shadow-black/10">
                ...
                <textarea
                    ...
                    name="notes"
                    rows="4"
                    class="mt-3 block w-full rounded-2xl border border-slate-200/80 bg-white px-4 py-3 text-sm text-slate-900 outline-none transition duration-200 focus:border-[#070740]/20 focus:ring-4 focus:ring-[#070740]/10 dark:border-slate-800 dark:bg-slate-950 dark:text-white"
            ...
            <section class="rounded-3xl border border-slate-200/80 bg-white p-5 shadow-sm shadow-slate-900/5 dark:border-slate-800 dark:bg-slate-900 dark:shadow-black/10">
                ...
                <div class="mt-5 flex flex-wrap gap-3">
                    <button
                        ...
                        class="inline-flex items-center justify-center rounded-2xl bg-[#070740] px-5 py-3 text-sm font-semibold text-white transition duration-200 hover:bg-[#0a0d3f] focus:outline-none focus-visible:ring-2 focus-visible:ring-[#070740] focus-visible:ring-offset-2"
                    >
