            ...
            <div class="mt-6 flex flex-wrap items-center gap-3">
                @if ($order->user_id && auth()->check())
                    <a
                        ...
                        class="font-display inline-flex items-center justify-center rounded-2xl bg-primary px-4 py-2.5 text-sm font-semibold text-white transition duration-200 hover:bg-primary-hover focus:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2"
                    >
                        {{ __('View Order') }}
                    </a>
                @endif
