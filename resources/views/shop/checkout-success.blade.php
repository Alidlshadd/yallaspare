            ...
            <div class="mt-6 flex flex-wrap items-center gap-3">
                @if ($order->user_id && auth()->check())
                    <a
                        ...
                        class="inline-flex items-center justify-center rounded-2xl bg-[#070740] px-4 py-2.5 text-sm font-semibold text-white transition duration-200 hover:bg-[#0a0d3f] focus:outline-none focus-visible:ring-2 focus-visible:ring-[#070740] focus-visible:ring-offset-2"
                    >
                        {{ __('View Order') }}
                    </a>
                @endif
