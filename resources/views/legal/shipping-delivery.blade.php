...
@section('content')
    <div data-vision-page class="mx-auto w-full max-w-5xl">
        ...
        <div class="del-road sup-in mt-10" style="animation-delay: .15s" aria-hidden="true">
            ...
            <div class="del-truck">
                <svg viewBox="0 0 96 44" class="h-[52px] w-[113px]">
                    ...
                    <rect x="2" y="25" width="56" height="4" fill="#ff8a3d" />
                    ...
                    <circle cx="84" cy="25" r="1.8" fill="#ff8a3d" />
                    {{-- chassis line --}}
                    <rect x="4" y="31" width="80" height="2.5" rx="1.25" fill="#070740" />
                    {{-- wheels --}}
                    <circle cx="17" cy="36" r="6.5" fill="#070740" stroke="#64748b" stroke-width="2" />
                    <circle cx="17" cy="36" r="2.2" fill="#cbd5e1" />
                    <circle cx="69" cy="36" r="6.5" fill="#070740" stroke="#64748b" stroke-width="2" />
        ...
        <section data-vision-reveal class="mt-6 rounded-2xl border border-amber-300/70 bg-amber-50/70 p-7 dark:border-amber-400/25 dark:bg-amber-400/5">
            <h2 class="flex items-center gap-3 text-xl font-semibold tracking-tight text-accent dark:text-accent">
            ...
            <p class="mt-3 text-sm leading-relaxed text-accent/90 dark:text-accent/90">
