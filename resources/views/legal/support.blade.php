...
@section('content')
    <section class="sup-in mx-auto w-full max-w-5xl">
        ...
        <h1 class="mt-5 text-4xl font-semibold tracking-tight text-slate-900 sm:text-5xl">{{ __('What do you need help with today?') }}</h1>
    ...
    <section class="mx-auto mt-10 grid w-full max-w-5xl grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
        ...
        >
            ...
            <span class="mt-5 block text-base font-semibold text-slate-900">{{ __('Where is my order?') }}</span>
            <span class="mt-1.5 block text-sm leading-relaxed text-slate-500">{{ __('Shipping tracking and delivery status') }}</span>
        </a>

        <a
            href="{{ route('legal.return-exchange') }}"
            class="sup-in group rounded-2xl border border-slate-200/80 bg-white p-6 shadow-sm transition duration-300 hover:-translate-y-1.5 hover:border-slate-300 hover:shadow-xl dark:bg-slate-900 dark:hover:border-slate-700"
        ...
        >
            ...
            <span class="mt-5 block text-base font-semibold text-slate-900">{{ __('Return / Exchange') }}</span>
            <span class="mt-1.5 block text-sm leading-relaxed text-slate-500">{{ __('Open a return request within 7 days') }}</span>
        </a>
        ...
        >
            ...
            <span class="mt-5 block text-base font-semibold text-slate-900">{{ __('Account') }}</span>
            <span class="mt-1.5 block text-sm leading-relaxed text-slate-500">{{ __('Password, verification, and sign-in issues') }}</span>
        </a>
        ...
        >
            ...
            <span class="mt-5 block text-base font-semibold text-slate-900">{{ __('Payment & Billing') }}</span>
            <span class="mt-1.5 block text-sm leading-relaxed text-slate-500">{{ __('Payments, invoices, and billing requests') }}</span>
        </a>
    </section>

    <section class="sup-in mx-auto mt-7 flex w-full max-w-5xl flex-wrap gap-3" style="animation-delay: .42s">
        <span class="inline-flex items-center gap-2.5 rounded-full border border-slate-200/80 bg-white px-4 py-2 text-xs font-medium text-slate-600 dark:bg-slate-900">
            @if ($supportOpenToday)
        ...
        <span class="inline-flex items-center gap-2 rounded-full border border-slate-200/80 bg-white px-4 py-2 text-xs font-medium text-slate-600 dark:bg-slate-900">
    ...
    <section class="sup-in mx-auto mt-16 w-full max-w-5xl" style="animation-delay: .58s">
        ...
        <div class="mt-5 rounded-2xl border border-slate-200/80 bg-white px-6 shadow-sm dark:bg-slate-900">
            <div class="divide-y divide-slate-200/70 dark:divide-slate-800/70">
                <details class="group py-5">
                    <summary class="flex cursor-pointer list-none items-center justify-between gap-6 text-sm font-medium text-slate-700 transition-colors hover:text-primary focus:outline-none dark:hover:text-white focus-visible:ring-2 focus-visible:ring-accent">
    ...
    <section class="sup-in mx-auto mt-10 w-full max-w-5xl rounded-2xl border border-slate-200/80 bg-white p-6 shadow-sm sm:p-7 dark:bg-slate-900" style="animation-delay: .66s">
        <div class="flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
            <div>
                <h2 class="text-xl font-semibold tracking-tight text-slate-900">{{ __('Still need help?') }}</h2>
            ...
            <div class="flex flex-wrap items-center gap-3">
                <a
                    ...
                    class="inline-flex items-center justify-center rounded-xl border border-slate-200 px-5 py-3 text-sm font-semibold text-slate-700 transition hover:-translate-y-0.5 hover:border-slate-300 hover:bg-slate-50 dark:hover:border-slate-600 dark:hover:bg-slate-800"
                >
                    {{ __('Urgent Issue') }}
                </a>
                <a
                    href="{{ route('legal.contact', ['topic' => 'general']) }}"
                    class="inline-flex items-center justify-center rounded-xl bg-primary px-6 py-3 text-sm font-semibold text-white shadow-sm transition hover:-translate-y-0.5 hover:bg-navy hover:shadow-lg focus:outline-none focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-2 focus-visible:ring-offset-white dark:focus-visible:ring-offset-slate-950"
                >
                    {{ __('General Support') }}
                </a>
            </div>
