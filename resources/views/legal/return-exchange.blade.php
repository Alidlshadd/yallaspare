...
@section('content')
    <div data-vision-page class="mx-auto w-full max-w-6xl">
        <section class="sup-in">
            ...
            <h1 class="mt-5 text-4xl font-semibold tracking-tight text-slate-900 sm:text-5xl">{{ __('Return & Exchange Policy') }}</h1>
            ...
            <a
                ...
                class="mt-6 inline-flex items-center gap-2 rounded-xl bg-accent px-5 py-3 text-sm font-bold text-primary dark:text-navy shadow-sm transition hover:-translate-y-0.5 hover:bg-accent hover:shadow-lg focus:outline-none focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-2 md:hidden"
            >
        ...
        <div class="mt-10 md:grid md:grid-cols-[200px,1fr] md:gap-8 lg:grid-cols-[230px,1fr] lg:gap-10">
            <aside class="hidden md:block">
                <nav class="sup-in sticky top-24 rounded-2xl border border-slate-200/80 bg-white p-4 shadow-sm dark:bg-slate-900" style="animation-delay: .12s">
                    <p class="px-3 pb-2 pt-1 text-[10px] font-bold uppercase tracking-[0.18em] text-muted dark:text-slate-500">{{ __('On this page') }}</p>
                    <a href="#period" class="block rounded-lg px-3 py-2 text-sm text-slate-600 transition hover:bg-slate-100 hover:text-primary dark:hover:bg-slate-800 dark:hover:text-white">{{ __('Return Period') }}</a>
                    <a href="#conditions" class="block rounded-lg px-3 py-2 text-sm text-slate-600 transition hover:bg-slate-100 hover:text-primary dark:hover:bg-slate-800 dark:hover:text-white">{{ __('Return Conditions') }}</a>
                    <a href="#damaged" class="block rounded-lg px-3 py-2 text-sm text-slate-600 transition hover:bg-slate-100 hover:text-primary dark:hover:bg-slate-800 dark:hover:text-white">{{ __('Damaged or Incorrect Items') }}</a>
                    <a href="#shipping" class="block rounded-lg px-3 py-2 text-sm text-slate-600 transition hover:bg-slate-100 hover:text-primary dark:hover:bg-slate-800 dark:hover:text-white">{{ __('Shipping Costs') }}</a>
                    <a href="#refund" class="block rounded-lg px-3 py-2 text-sm text-slate-600 transition hover:bg-slate-100 hover:text-primary dark:hover:bg-slate-800 dark:hover:text-white">{{ __('Refund Process') }}</a>
                    <a href="#exchange" class="block rounded-lg px-3 py-2 text-sm text-slate-600 transition hover:bg-slate-100 hover:text-primary dark:hover:bg-slate-800 dark:hover:text-white">{{ __('Exchange Requests') }}</a>
                    <a href="#nonreturnable" class="block rounded-lg px-3 py-2 text-sm text-slate-600 transition hover:bg-slate-100 hover:text-primary dark:hover:bg-slate-800 dark:hover:text-white">{{ __('Non-Returnable Cases') }}</a>
                    <div class="mt-3 border-t border-slate-200/80 pt-3">
                        <a
                            href="{{ route('legal.contact', ['topic' => 'order']) }}"
                            class="block rounded-xl bg-accent px-3 py-2.5 text-center text-sm font-bold text-primary dark:text-navy transition hover:-translate-y-0.5 hover:bg-accent hover:shadow-md focus:outline-none focus-visible:ring-2 focus-visible:ring-accent"
                        >
                            {{ __('Open a return request') }} <span aria-hidden="true">&rarr;</span>
                        </a>
                    </div>
            ...
            <div class="space-y-5">
                <section id="period" data-vision-reveal class="grid scroll-mt-28 grid-cols-[104px,1fr] overflow-hidden rounded-2xl border border-slate-200/80 bg-white shadow-sm dark:bg-slate-900">
                    ...
                    <div class="p-6">
                        <h2 class="text-lg font-semibold tracking-tight text-slate-900">{{ __('Return Period') }}</h2>
                ...
                <section id="conditions" data-vision-reveal class="grid scroll-mt-28 grid-cols-[104px,1fr] overflow-hidden rounded-2xl border border-slate-200/80 bg-white shadow-sm dark:bg-slate-900">
                    <aside class="flex flex-col items-center justify-center gap-0.5 bg-primary px-3 py-6 text-center">
                    ...
                    <div class="p-6">
                        <h2 class="text-lg font-semibold tracking-tight text-slate-900">{{ __('Return Conditions') }}</h2>
                        <p class="mt-2.5 text-sm leading-relaxed text-slate-600">{{ __('To be eligible for a return, the product must meet the following conditions:') }}</p>
                ...
                <section id="damaged" data-vision-reveal class="grid scroll-mt-28 grid-cols-[104px,1fr] overflow-hidden rounded-2xl border border-accent/70 bg-white shadow-sm ring-2 ring-accent/15 dark:border-accent/30 dark:bg-slate-900">
                    ...
                    <div class="p-6">
                        <h2 class="text-lg font-semibold tracking-tight text-slate-900">{{ __('Damaged or Incorrect Items') }}</h2>
                        <p class="mt-2.5 text-sm leading-relaxed text-slate-600">
                            {{ __('If you receive a damaged product or the wrong item, please contact us within 24 hours of delivery.') }}
                        </p>
                        <p class="mt-2 text-sm leading-relaxed text-slate-600">{{ __('Please provide:') }}</p>
                        <ul class="mt-2 flex flex-wrap gap-2">
                            <li class="rounded-full bg-slate-100 px-3 py-1.5 text-xs font-medium text-slate-700 dark:bg-slate-800">{{ __('Your order number') }}</li>
                            <li class="rounded-full bg-slate-100 px-3 py-1.5 text-xs font-medium text-slate-700 dark:bg-slate-800">{{ __('Photos of the product') }}</li>
                            <li class="rounded-full bg-slate-100 px-3 py-1.5 text-xs font-medium text-slate-700 dark:bg-slate-800">{{ __('Photos of the packaging') }}</li>
                        </ul>
                ...
                <section id="shipping" data-vision-reveal class="grid scroll-mt-28 grid-cols-[104px,1fr] overflow-hidden rounded-2xl border border-slate-200/80 bg-white shadow-sm dark:bg-slate-900">
                    ...
                    <div class="p-6">
                        <h2 class="text-lg font-semibold tracking-tight text-slate-900">{{ __('Shipping Costs') }}</h2>
                        <p class="mt-2.5 text-sm leading-relaxed text-slate-600">
                ...
                <section id="refund" data-vision-reveal class="grid scroll-mt-28 grid-cols-[104px,1fr] overflow-hidden rounded-2xl border border-slate-200/80 bg-white shadow-sm dark:bg-slate-900">
                    <aside class="flex flex-col items-center justify-center gap-0.5 bg-primary px-3 py-6 text-center">
                    ...
                    <div class="p-6">
                        <h2 class="text-lg font-semibold tracking-tight text-slate-900">{{ __('Refund Process') }}</h2>
                        <p class="mt-2.5 text-sm leading-relaxed text-slate-600">
                ...
                <section id="exchange" data-vision-reveal class="grid scroll-mt-28 grid-cols-[104px,1fr] overflow-hidden rounded-2xl border border-slate-200/80 bg-white shadow-sm dark:bg-slate-900">
                    <aside class="flex flex-col items-center justify-center gap-0.5 bg-primary px-3 py-6 text-center">
                    ...
                    <div class="p-6">
                        <h2 class="text-lg font-semibold tracking-tight text-slate-900">{{ __('Exchange Requests') }}</h2>
                        <p class="mt-2.5 text-sm leading-relaxed text-slate-600">
                ...
                <section id="nonreturnable" data-vision-reveal class="grid scroll-mt-28 grid-cols-[104px,1fr] overflow-hidden rounded-2xl border border-slate-200/80 bg-white shadow-sm dark:bg-slate-900">
                    <aside class="flex flex-col items-center justify-center bg-primary px-3 py-6 text-accent">
                    ...
                    <div class="p-6">
                        <h2 class="text-lg font-semibold tracking-tight text-slate-900">{{ __('Non-Returnable Cases') }}</h2>
                        <p class="mt-2.5 text-sm leading-relaxed text-slate-600">
                ...
                <section data-vision-reveal class="rounded-2xl border border-slate-200/80 bg-white p-7 shadow-sm dark:bg-slate-900">
                    <div class="flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
                        <div>
                            <h2 class="text-xl font-semibold tracking-tight text-slate-900">{{ __('Contact') }}</h2>
                            <p class="mt-2 text-sm leading-relaxed text-slate-600">
                        ...
                        <a
                            href="{{ route('legal.contact', ['topic' => 'order']) }}"
                            class="inline-flex shrink-0 items-center gap-2 rounded-xl bg-accent px-5 py-3 text-sm font-bold text-primary dark:text-navy shadow-sm transition hover:-translate-y-0.5 hover:bg-accent hover:shadow-lg focus:outline-none focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-2 focus-visible:ring-offset-white dark:focus-visible:ring-offset-slate-950"
                        >
                            {{ __('Open a return request') }} <span aria-hidden="true">&rarr;</span>
                        </a>
                    </div>
