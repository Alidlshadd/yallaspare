...
<section class="bg-[#070740] py-10 text-white dark:bg-slate-900">
        ...
        <div class="grid gap-8 md:grid-cols-2 lg:grid-cols-5">
            ...
            <div class="space-y-3">
                ...
                <div class="flex flex-col gap-2 text-sm">
                    ...
                    <a href="{{ url('/vision') }}" class="group inline-flex w-fit items-center gap-1.5 font-semibold text-accent-ink transition hover:text-accent dark:text-accent dark:hover:text-accent-hover">
